...
export const STYLE_SCHEMA: PropSchema = defineSchema([
  ...
  },
  {
    ...
    type: 'size',
    group: '布局',
    visibleWhen: { field: 'position', equals: 'absolute' },
  },
  {
    key: 'top',
    label: 'Y 坐标',
  ...
  // 颜色
  {
    ...
    type: 'color',
    group: '外观',
    placeholder: '如 #ffffff 或 transparent',
  },
  ...
  { key: 'borderRadius', label: '圆角', type: 'size', group: '边框', unit: 'px' },
  {
    ...
    type: 'border',
    group: '边框',
    placeholder: '如 1px solid #e5e7eb',
  },
  {
    key: 'boxShadow',
    label: '阴影',
