...
export const remoteConfigStatus = z.enum(['idle', 'success', 'signature_failed', 'unreachable', 'invalid']);
...
export const TABLE_COLUMNS = {
  user: ['id', 'login', 'display_name', 'avatar_ref', 'role', 'settings_json', 'created_at', 'updated_at'],
  workspace: ['id', 'user_id', 'name', 'kind', 'config_json', 'created_at', 'updated_at'],
  project: ['id', 'user_id', 'workspace_id', 'name', 'description', 'tech_stack_json', 'status', 'target_platforms', 'tech_stack_fingerprint', 'git_remote', 'pinned', 'last_opened_at', 'deleted_at', 'source_kind', 'source_ref', 'created_at', 'updated_at'],
  ...
  element: ['id', 'page_id', 'parent_id', 'type', 'name', 'props_json', 'style_json', 'feature_ref', 'note_id', 'order_index', 'anchor_json', 'created_at', 'updated_at'],
  document: ['id', 'project_id', 'kind', 'title', 'content_ref', 'version', 'format', 'content_text', 'sections_json', 'source_ref', 'deleted_at', 'ignored_version', 'created_at', 'updated_at'],
  doc_version: ['id', 'document_id', 'version', 'title', 'content_text', 'sections_json', 'created_by', 'created_at'],
  memory_item: ['id', 'user_id', 'scope', 'project_id', 'feature_id', 'page_id', 'element_id', 'issue_id', 'title', 'content', 'structured', 'tags', 'source_type', 'source_ref', 'confidence', 'importance', 'status', 'pinned', 'version', 'created_at', 'updated_at', 'embedding', 'issue_status'],
  memory_doc_link: ['id', 'memory_id', 'document_id', 'link_type', 'created_at'],
  code_anchor: ['id', 'project_id', 'element_id', 'page_id', 'feature_id', 'file_path', 'symbol', 'start_line', 'end_line', 'kind', 'commit_sha', 'created_at', 'updated_at'],
  pipeline_run: ['id', 'project_id', 'stage', 'status', 'artifact_type', 'version', 'content_ref', 'diff_ref', 'created_at', 'updated_at'],
  stage_artifact: ['id', 'run_id', 'project_id', 'stage', 'artifact_type', 'version', 'content_ref', 'diff_ref', 'created_at'],
  provider: ['id', 'user_id', 'name', 'protocol', 'base_url', 'api_key_ref', 'headers_json', 'default_timeout', 'supports_stream', 'supports_tools', 'supports_vision', 'enabled', 'sort_order', 'version', 'manual_models_json', 'created_at', 'updated_at'],
  model: ['id', 'provider_id', 'name', 'display_name', 'context_window', 'max_output', 'capabilities_json', 'version', 'created_at', 'updated_at'],
  usage_record: ['id', 'user_id', 'provider_id', 'model_id', 'project_id', 'prompt_tokens', 'completion_tokens', 'total_tokens', 'cost', 'purpose', 'latency_ms', 'created_at'],
  ai_model_config: ['id', 'user_id', 'purpose_bindings_json', 'use_default_for_all', 'default_model_id', 'created_at', 'updated_at'],
  remote_config_source: ['id', 'user_id', 'name', 'url', 'public_key', 'enabled', 'update_interval_min', 'last_fetch_at', 'last_status', 'last_error', 'last_payload_json', 'applied_revision', 'acked_revision', 'created_at', 'updated_at'],
  registry_entry: ['id', 'project_id', 'entity_type', 'entity_id', 'canonical_name', 'projections_json', 'aliases_json', 'naming_rule_id', 'name_history_json', 'sync_state', 'created_at', 'updated_at'],
  occurrence: ['id', 'registry_id', 'kind', 'ref_path', 'locator', 'matched_symbol', 'confidence', 'risk_level', 'status', 'created_at', 'updated_at'],
  rename_event: ['id', 'project_id', 'registry_id', 'old_name', 'new_name', 'changeset_json', 'scope', 'commit_sha', 'undone', 'created_at'],
  package_job: ['id', 'direction', 'scope', 'includes_json', 'excludes_json', 'file_path', 'format_version', 'encryption', 'redacted', 'status', 'counts_json', 'error_log_ref', 'created_at', 'updated_at'],
  ...
  memory_change_log: ['id', 'user_id', 'memory_id', 'action', 'policy', 'source_type', 'source_conversation_id', 'source_snippet', 'before_json', 'after_json', 'detail_json', 'created_at'],
  memory_struct_revision: ['id', 'memory_id', 'page_id', 'revision', 'token_estimate', 'truncated', 'summary_json', 'diff_json', 'created_at'],
} as const;
